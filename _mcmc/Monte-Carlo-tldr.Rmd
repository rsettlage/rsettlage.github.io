...
\begin{equation}
\tag{6}
E[x^4] = \int_{-\infty}^{\infty} x^4\;p(x)\;dx = \int_{-\infty}^{\infty}x^4\;\frac{e^{-\tfrac{(x-E[x])^2}{2}}}{\sqrt{2\pi}}\;dx = ??
\end{equation}
$$
Could do this integral using some tricks, but instead, perhaps use Monte Carlo method:
...
It appears to be converging.  The variance seems to converge as well, but the scale makes it less informative.  Show sd?  eh.
